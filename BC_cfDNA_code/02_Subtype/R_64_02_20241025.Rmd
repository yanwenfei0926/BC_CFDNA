...
# 2. loading data
```{r}
Model_01_ERPR <- read.xlsx("./ERPR/ERPR_LASSO_02_GLM/02_prediction_results.xlsx", sheet = 1, skipEmptyRows = FALSE, colNames = TRUE)
colnames(Model_01_ERPR)<-c("Sample", "actual", "predicted", "predicted_prob")

Model_02_HER2 <- read.xlsx("./HER2/HER2_LASSO_02_GLM/02_prediction_results.xlsx", sheet = 1, skipEmptyRows = FALSE, colNames = TRUE)
colnames(Model_02_HER2)<-c("Sample", "actual", "predicted", "predicted_prob")

Model_03_TNBC <- read.xlsx("./TNBC/TNBC_LASSO_02_GLM/02_prediction_results.xlsx", sheet = 1, skipEmptyRows = FALSE, colNames = TRUE)
...
## 4.3 plot2
```{r}
pdf('20241115_02_External_validation_Dataset_ROC_v2.pdf', width = 8, height = 6)
