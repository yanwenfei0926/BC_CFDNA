...
pdf('20241216_02_Internal_Validation_Dataset_Heatmap_v1.pdf', width = 10, height = 6)
ggplot(data = conf_matrix_df, aes(x = Prediction, y = Reference)) +
  ...
  scale_fill_gradient(low = "#FFFFFF", high = "#FFCD7C") +
  theme_minimal() +
  labs(title = "Validation Dataset", x = "Predicted", y = "Actual") +
