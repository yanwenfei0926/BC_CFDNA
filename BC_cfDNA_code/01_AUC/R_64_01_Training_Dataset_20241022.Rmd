...
Model_02_GLM <- read.xlsx("./02_GLM_v3/01_prediction_results.xlsx", sheet = 1, skipEmptyRows = FALSE, colNames = TRUE)
colnames(Model_02_GLM)<-c("Sample", "actual", "predicted", "predicted_prob")

Model_03_SVM <- read.xlsx("./03_SVM_v3/01_prediction_results.xlsx", sheet = 1, skipEmptyRows = FALSE, colNames = TRUE)
colnames(Model_03_SVM)<-c("Sample", "actual", "predicted", "predicted_prob")

Model_05_GBM <- read.xlsx("./05_GBM_v3/01_prediction_results.xlsx", sheet = 1, skipEmptyRows = FALSE, colNames = TRUE)
colnames(Model_05_GBM)<-c("Sample", "actual", "predicted", "predicted_prob")

Model_07_XGBoost <- read.xlsx("./07_XGBoost_v3/01_prediction_results.xlsx", sheet = 1, skipEmptyRows = FALSE, colNames = TRUE)
colnames(Model_07_XGBoost)<-c("Sample", "actual", "predicted", "predicted_prob")

Model_11_MLP <- read.xlsx("./11_MLP_v3/01_prediction_results.xlsx", sheet = 1, skipEmptyRows = FALSE, colNames = TRUE)
colnames(Model_11_MLP)<-c("Sample", "actual", "predicted", "predicted_prob")

Model_21_Stacked_ensemble <- read.xlsx("./21_Stacked_ensemble_v3/01_prediction_results.xlsx", sheet = 1, skipEmptyRows = FALSE, colNames = TRUE)
...
## 4.3 plot2
```{r}
pdf('20250116_01_Training_Dataset_ROC_v2.pdf', width = 8, height = 6)
